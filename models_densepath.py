...
class Single_level_densenet(nn.Module):
    def __init__(self, filters, num_conv=4):
        ...
        self.out_conv = nn.Conv2d(filters, filters, 1, padding=0)
    def forward(self, x):
        outs = []
        outs.append(x)
        for i in range(self.num_conv):
        ...
        out_final = outs[-1]
        del outs
        out_final = F.relu(self.out_conv(out_final))
...
class Unet(nn.Module):
    def __init__(self):
        ...
        self.d1 = Single_level_densenet(32, 4)
        self.d2 = Single_level_densenet(64, 4)
        self.d3 = Single_level_densenet(128, 4)
        self.d4 = Single_level_densenet(256, 4)
